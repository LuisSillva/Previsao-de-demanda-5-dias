...
print("A previsão de vendas do dia 21/01/2023 é: ", media_sabados)
print("A previsão de vendas do dia 22/01/2023 é: ", media_domingos)
print("A previsão de vendas do dia 23/01/2023 é: ", media_segundas)
print("A previsão de vendas do dia 24/01/2023 é: ", media_tercas)
print("A previsão de vendas do dia 25/01/2023 é: ", media_quartas)
